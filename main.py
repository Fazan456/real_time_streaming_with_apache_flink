...
def generate_sales_transactions():
    ...
    return {
        ...
        'productPrice': round(random.uniform(10, 1000), 2), #ranging from 10 to 1000, and rounds it to two decimal places before storing it in the variable productPrice.
        'productQuantity': random.randint(1, 10), #ranging from 1 to 10
